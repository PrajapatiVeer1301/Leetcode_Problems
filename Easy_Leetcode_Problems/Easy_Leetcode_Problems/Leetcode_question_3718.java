...
//
// Step 2: Create a HashSet from nums for fast searching.
//
// Step 3: Start with:
//
//         multiple = k
//
// Step 4: While multiple is present in the set:
//
//         multiple += k
//
...
//
// Creating the HashSet takes O(n).
//
// Each HashSet lookup takes O(1) average.
//
// Space Complexity: O(n).
//
// Because we create a HashSet containing nums.