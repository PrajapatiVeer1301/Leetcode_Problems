...
#
# For every character, we find its position in the reversed alphabet.
#
# Normal alphabet:
#
# a = 1, b = 2, c = 3, ..., z = 26
...
# a = 26, b = 25, c = 24, ..., z = 1
#
# We can calculate the reverse alphabet position using:
#
...
# string_position = i + 1
#
# Finally, add all the products to get the answer.
#
#
# 🔄 Algorithm
#
...
# reversed alphabet using ord('z') - ord(ch) + 1.
